This program writes the fibonacci series with loops in Java. It takes the number of elements of the Fibonacci series from the user and writes it to the screen.
